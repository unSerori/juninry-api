...
// ニャリオットの取得
func GetMainNyairot(userUuid string) (HungryStatus, error) {
	var mianNyariot HungryStatus
	_, err := db.Where("user_uuid = ?", userUuid).Get(&mianNyariot)
	return mianNyariot, err
}
